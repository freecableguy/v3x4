...
#define			MAX_PACKAGE_COUNT		4				// maximum number of supported packages/sockets, increase as needed
...
const UINT32 SVID_FIXED_VCCIN[MAX_PACKAGE_COUNT] \
	= { _DYNAMIC_SVID, _DYNAMIC_SVID, _DYNAMIC_SVID, _DYNAMIC_SVID };
...
const UINT32 IACORE_ADAPTIVE_OFFSET[MAX_PACKAGE_COUNT] \
	= { _DYNAMIC_FVID, _DYNAMIC_FVID, _DYNAMIC_FVID, _DYNAMIC_FVID };
...
const UINT32 SA_ADAPTIVE_OFFSET[MAX_PACKAGE_COUNT] \
	= { _DYNAMIC_FVID, _DYNAMIC_FVID, _DYNAMIC_FVID, v };
